...
# Versión 2, encapsulado en una función

def aprox_pi(terminos: int) -> float:
    denominador = 1
    signo = 1
    ...
    return 4 * pi_entre_cuatro

sumandos = int(input("Con cuantos sumandos quieres aproximar PI? "))
print(aprox_pi(sumandos))
